                ...
                builder: (context) {
                  return Column(
                    ...
                    children: [
                      ...
                      /* ----------------- 구분선 -----------------  */
                      const ProfileDivinderWidget(),
                      Container(color: ColorStyles.gray1, height: 26),
                      /* ----------------- 자가 진단 테스트 뷰 -----------------  */
                      Container(
                      ...
                      Container(color: ColorStyles.gray1, height: 30),
                          ...
                          children: [
                            Expanded(
                              child: ProfileInfoIconBtnWidget(
                                goPage: "/profile/boho",
                                iconImg:
                                    'assets/icons/icon-mypage-protector.svg',
                                text: '보호자',
                              ),
                            ),
                            Expanded(
                              child: ProfileInfoIconBtnWidget(
                                ...
                                iconImg:
                                    'assets/icons/icon-mypage-hospital.svg',
                                text: '병원 기록',
                              ),
                            ),
                            Expanded(
...
class ProfileDivinderWidget extends StatelessWidget {
  const ProfileDivinderWidget({
    super.key,
  });
