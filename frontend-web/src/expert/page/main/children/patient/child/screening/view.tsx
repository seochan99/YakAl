      ...
      <S.ColumnDiv>
        ...
        <S.CardDiv>
          <S.HeaderDiv>
            ...
            <S.RightTitleDiv>
              <S.SubtitleSpan>
                {totalScore.gds <= 5 && "정상"}
                {6 <= totalScore.gds && totalScore.gds <= 10 && "중간 정도의 우울상태"}
                {11 <= totalScore.gds && totalScore.gds <= 15 && "중증도의 우울증"}
              </S.SubtitleSpan>
        ...
        <S.CardDiv>
          <S.HeaderDiv>
            ...
            <S.RightTitleDiv>
              <S.SubtitleSpan>
                {0 <= totalScore.phqNine && totalScore.phqNine <= 4 && "우울증상 없음"}
                {5 <= totalScore.phqNine && totalScore.phqNine <= 9 && "가벼울 우울증상"}
          ...
          <S.HeaderDiv>
            ...
            <S.RightTitleDiv>
              <S.SubtitleSpan>
                ...
                {10 <= totalScore.drinking && totalScore.drinking <= 15 && "습관성 과음 주의"}
                {16 <= totalScore.drinking && totalScore.drinking <= 19 && "위험 수준"}
                {20 <= totalScore.drinking && totalScore.drinking <= 40 && "매우 위험"}
              </S.SubtitleSpan>
        ...
        <S.CardDiv>
          ...
          <S.ContentDiv>
            <S.RowDiv>
              <S.LeftTitleDiv>
                <S.NormalSpan>
                  {screeningDetail.smoking[0] === 0 && "비흡연자"}
