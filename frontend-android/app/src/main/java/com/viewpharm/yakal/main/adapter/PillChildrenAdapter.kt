...
class PillChildrenAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PillChildrenViewHolder {
        return PillChildrenViewHolder(ItemHomePillSubBinding.inflate(
    ...
    inner class PillChildrenViewHolder(val binding: ItemHomePillSubBinding) : RecyclerView.ViewHolder(binding.root) {
